...
function myFunction() {
    ...
    if (x === 'tidal') {
        ...
        setTimeout(function () {
            ...
            wind_mix.play();
            var tv_sound = document.getElementById('crickets');
            tv_sound.play();
    ...
    if (x === 'ambient') {
        ...
        setTimeout(function () {
            ...
            var nightCrickets_sound = document.getElementById('crickets');
            nightCrickets_sound.play();
    ...
    if (x === 'stormy') {
        ...
        setTimeout(function () {
            ...
            thunder_mix.play();
            var nightCrickets_sound = document.getElementById('waves');
            nightCrickets_sound.play();
...
function setLocalStorage() {
    if (localStorage.getItem('server') != "") {
        // var input = document.getElementById('current_shared_url').value;
        // var asd = localStorage.setItem('server', input);
...
function getLocalStorage() {
    ...
    var arrayLength = storedMix.length;
    var temp = "";

    for (var i = 0; i < arrayLength; i++) {
        var c = document.getElementById('data').innerHTML = storedMix[i]
        temp += array[i] + '</br>';
        console.log(storedMix[i]);
        //Do something
    }
}
