                           ...
                           <div class="row animated  bounceInUp delay-4s">
                                <div class="col-md-4">
                                    <div class="audio-div ">
                                        ...
                                        <!--Audio File-->
                                        <audio id="fire" class="fire" src="./assets/sound/camp_fire.mp4" preload="auto" loop></audio>
                                ...
                                <div class="col-md-4">
                                    <div class="audio-div ">
                                        ...
                                        <!--Audio File-->
                                        <audio id="thunder" class="thunder" src="./assets/sound/double_thunder.mp4" preload="auto" loop></audio>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="audio-div ">
                                        ...
                                        <!--Audio File-->
                                        <audio id="wind" src="./assets/sound/strong_wind.mp4" preload="auto" loop></audio>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row animated   bounceInUp  delay-5s">
                                <div class="col-md-4">
                                    <div class="audio-div ">
                                        ...
                                        <audio id="rain" src="./assets/sound/light_rain.mp4" preload="auto" loop></audio>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="audio-div ">
                                        ...
                                        <!--Audio File-->
                                        <audio id="waves" class="waves" src="./assets/sound/lake_waves.mp4" preload="auto" loop></audio>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="audio-div ">
                                        ...
                                        <audio id="birds" class="birds" src="./assets/sound/bird_chirping.mp4" preload="auto" loop></audio>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row animated   bounceInUp  delay-6s">
                                <div class="col-md-4">
                                    <div class="audio-div ">
                                        ...
                                        <!--Audio File-->
                                        <audio id="crickets" class="crickets" src="./assets/sound/night_cricket.mp4" preload="auto" loop></audio>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="audio-div ">
                                        ...
                                        <!--Audio File-->
                                        <audio id="singing_bowl" class="singing_bowl" src="./assets/sound/14inch_bowl.mp4" preload="auto" loop></audio>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="audio-div ">
                                        ...
                                        <!--Audio File-->
                                        <audio id="tv" class="tv" src="./assets/sound/white_noise.mp4" preload="auto" loop></audio>
                                    </div>
                                </div>
                            </div>
                        </div>
