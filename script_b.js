...
var arr_sounds = { fire: false, thunder: false, wind: false, rain: false, waves: false, birds: false, crickets: false, singing_bowl: false, tv: false, track_1: false, track_2: false, track_3: false, track_4: false, track_5: false, track_6: false, track_7: false, track_8: false, track_9: false, si: false, la: false, sol: false, fa: false, mi: false, re: false, ut: false, hel: false, nat: false };
...
function playTune(object) {
    ...
    var c = 'fire:0,thunder:0,wind:0,rain:0,waves:0,birds:0,crickets:0,singing_bowl:0,tv:0,track_1:0,track_2:0,track_3:0,track_4:0,track_5:0,track_6:0,track_7:0,track_8:0,track_9:0,si:0,la:0,sol:0,fa:0,mi:0,re:0,ut:0,hel:0,nat:0';
    console.log(c)
    var nameArr = c.split(',');
    for (j = 0; j < nameArr.length; j++) {
        sound_id = nameArr[j].split(':')[0];
