...
var arr_sounds = { fire: false, thunder: false, wind: false, rain: false, waves: false, birds: false, crickets: false, singing_bowl: false, tv: false, track_1: false, track_2: false, track_3: false, track_4: false, track_5: false, track_6: false, track_7: false, track_8: false, track_9: false };
...
function hit() {
    ...
    this.share_fb = function () {
        console.log('fb-url: hit ', current_location)
...
jQuery(function () {
    ...
    document.getElementById('playButton').onclick = function () {
        ...
        $('input[type=range]').css('background' , 'transparent');
        var sounds_names = idArray;
        $.each(sounds_names, function (index, value) {
            var a = $('[volumee="' + value + '"]').val();
            if (a > 0) {
        ...
        setTimeout(function () {
            ...
            var myDiv = $('[volumee="rain"]').val(0);
             var myDiv = $('[id="liver"]').val(0);
            var amount = 0
            var masterVolume = document.getElementById('masterAudio').value;
            var master_vol = masterVolume
            if (global_volume == true) {
            ...
            sound_each.play();
            var myDiv = $('[volumee="fire"]').val(0.50);
              var myDiv = $('[id="blood"]').val(50);
        ...
        setTimeout(function () {
            ...
            var myDiv = $('[volumee="thunder"]').val(0.50);
            var myDive = $('[id="adrenals"]').val(50);
            var amount = 0.50
            var masterVolume = document.getElementById('masterAudio').value;
            var master_vol = masterVolume
            if (global_volume == true) {
        ...
        var input = document.getElementById("vol").value = 0;
        setTimeout(function () {
            var sound_each = document.getElementById('birds')
            if (global_volume == true) {
                sound_each.play();
                sound_each.volume = 0
            }
            ...
            var myDiv = $('[volumee="birds"]').val(0);
            var myDive = $('[id="kidney"]').val(0);
            var amount = 0
            var masterVolume = document.getElementById('masterAudio').value;
            var master_vol = masterVolume
            if (global_volume == true) {
            ...
            var sound_each1 = document.getElementById('wind')
            if (global_volume == true) {
                sound_each1.play();
                sound_each1.volume = 0
            }
            ...
            arr_sounds.tv = true;
            var myDiv = $('[volumee="wind"]').val(0);
            var myDive = $('[id="bladder"]').val(0);
            var amount = 0
            var masterVolume = document.getElementById('masterAudio').value;
            var master_vol = masterVolume
            if (global_volume == true) {
        ...
        setTimeout(function () {
            ...
            arr_sounds.waves = true;
            var myDiv = $('[volumee="waves"]').val(0);
            var myDive = $('[id="intestines"]').val(0); 
            var amount = 0
            var masterVolume = document.getElementById('masterAudio').value;
            var master_vol = masterVolume
            if (global_volume == true) {
            ...
            // var sound_each1 = document.getElementById('crickets')
            // if (global_volume == true) {
            //     sound_each1.play();
            //     sound_each1.volume = 0.10
            // }
            // else {
            //     console.log('dddd')
            //     sound_each1.pause();
            //     sound_each1.volume = 0
            // }
            // arr_sounds.crickets = true;
            // var myDiv = $('[volumee="crickets"]').val(0.24);
            // var amount = 0.24
            // var masterVolume = document.getElementById('masterAudio').value;
            // var master_vol = masterVolume
            // if (global_volume == true) {
        ...
        setTimeout(function () {
            ...
            var myDiv = $('[volumee="singing_bowl"]').val(0);
            var myDive = $('[id="lungs"]').val(0);
            var amount = 0
            var masterVolume = document.getElementById('masterAudio').value;
            var master_vol = masterVolume
            if (global_volume == true) {
        ...
        setTimeout(function () {
            ...
            // var sound_each = document.getElementById('cricketss')
            // if (global_volume == true) {
            //     sound_each.play();
            //     sound_each.volume = 0
            // }
            ...
            // }
            // arr_sounds.singing_bowl = true;
            // var myDiv = $('[volumee="cricketss"]').val(0);
            // var myDive = $('[id="bladderr"]').val(0);
            // var amount = 0
            // var masterVolume = document.getElementById('masterAudio').value;
            // var master_vol = masterVolume
            // if (global_volume == true) {
            ...
            arr_sounds.crickets = true;
            var myDiv = $('[volumee="crickets"]').val(0);
            var amount = 0
            var masterVolume = document.getElementById('masterAudio').value;
            var master_vol = masterVolume
            if (global_volume == true) {
...
function myFunction() {
    ...
    if (x === 'soothe') {
        ...
        setTimeout(function () {
            ...
            var myDiv = $('[volumee="rain"]').val(0.50);
             var myDiv = $('[id="liver"]').val(50);
            var amount = 0.50
            var masterVolume = document.getElementById('masterAudio').value;
            var master_vol = masterVolume
            if (global_volume == true) {
    ...
    if (x === 'breezy') {
        ...
        setTimeout(function () {
            ...
            arr_sounds.wind = true;
            var myDiv = $('[volumee="birds"]').val(0.50);
            var myDive = $('[id="kidney"]').val(50);
            var amount = 0.50
            var masterVolume = document.getElementById('masterAudio').value;
            var master_vol = masterVolume
            if (global_volume == true) {
            ...
            arr_sounds.tv = true;
            var myDiv = $('[volumee="wind"]').val(0.50);
            var myDive = $('[id="bladder"]').val(50);
            var amount = 0.50
            var masterVolume = document.getElementById('masterAudio').value;
            var master_vol = masterVolume
            if (global_volume == true) {
    ...
    if (x === 'tidal') {
        ...
        setTimeout(function () {
            ...
            arr_sounds.waves = true;
            var myDiv = $('[volumee="waves"]').val(0.50);
            var myDive = $('[id="intestines"]').val(50); 
            var amount = 0.50
            var masterVolume = document.getElementById('masterAudio').value;
            var master_vol = masterVolume
            if (global_volume == true) {
    ...
    if (x === 'ambient') {
        ...
        setTimeout(function () {
            ...
            arr_sounds.singing_bowl = true;
            var myDiv = $('[volumee="singing_bowl"]').val(0.50);
            var myDive = $('[id="lungs"]').val(0.50);
            var amount = 0.50
            var masterVolume = document.getElementById('masterAudio').value;
            var master_vol = masterVolume
            if (global_volume == true) {
...
function playSoundEach(animal, amount) {
    ...
    if (global_volume == true) {
        ...
        if (master_vol > amount) {
            sound_each.volume = amount;
           // var valoume = document.getElementById("fire").volume = (value / 100) ;
           // console.log(valoume);
...
function playTune(object) {
    ...
    var c = 'fire:0,thunder:0,wind:0,rain:0,waves:0,birds:0,crickets:0,singing_bowl:0,tv:0,track_1:0,track_2:0,track_3:0,track_4:0,track_5:0,track_6:0,track_7:0,track_8:0,track_9:0';
    console.log(c)
    var nameArr = c.split(',');
    for (j = 0; j < nameArr.length; j++) {
        sound_id = nameArr[j].split(':')[0];
